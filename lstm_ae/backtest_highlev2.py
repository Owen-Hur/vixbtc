...
def main():
    ...
    # 전부 4단계: sc>=1.5 / sc>=1.0 / sc>=0.3 / else
    strategies = {
        # 기준
        "8/5/3/1":    lambda sc, v, a: 8.0 if a >= 1.5 else (5.0 if a >= 1.0 else (3.0 if a >= 0.3 else 1.0)),

        # max 10x 계열
        "10/5/3/1":   lambda sc, v, a: 10.0 if a >= 1.5 else (5.0 if a >= 1.0 else (3.0 if a >= 0.3 else 1.0)),
        "10/6/3/1":   lambda sc, v, a: 10.0 if a >= 1.5 else (6.0 if a >= 1.0 else (3.0 if a >= 0.3 else 1.0)),
        "10/6/4/1":   lambda sc, v, a: 10.0 if a >= 1.5 else (6.0 if a >= 1.0 else (4.0 if a >= 0.3 else 1.0)),
        "10/7/4/1":   lambda sc, v, a: 10.0 if a >= 1.5 else (7.0 if a >= 1.0 else (4.0 if a >= 0.3 else 1.0)),
        "10/6/4/2":   lambda sc, v, a: 10.0 if a >= 1.5 else (6.0 if a >= 1.0 else (4.0 if a >= 0.3 else 2.0)),
        "10/7/4/2":   lambda sc, v, a: 10.0 if a >= 1.5 else (7.0 if a >= 1.0 else (4.0 if a >= 0.3 else 2.0)),
        "10/8/5/2":   lambda sc, v, a: 10.0 if a >= 1.5 else (8.0 if a >= 1.0 else (5.0 if a >= 0.3 else 2.0)),

        # max 12x~15x 
        "12/8/4/1":   lambda sc, v, a: 12.0 if a >= 1.5 else (8.0 if a >= 1.0 else (4.0 if a >= 0.3 else 1.0)),
        "12/8/5/2":   lambda sc, v, a: 12.0 if a >= 1.5 else (8.0 if a >= 1.0 else (5.0 if a >= 0.3 else 2.0)),
        "15/8/4/1":   lambda sc, v, a: 15.0 if a >= 1.5 else (8.0 if a >= 1.0 else (4.0 if a >= 0.3 else 1.0)),
        "15/10/5/2":  lambda sc, v, a: 15.0 if a >= 1.5 else (10.0 if a >= 1.0 else (5.0 if a >= 0.3 else 2.0)),

        # max 20x
        "20/10/5/1":  lambda sc, v, a: 20.0 if a >= 1.5 else (10.0 if a >= 1.0 else (5.0 if a >= 0.3 else 1.0)),
        "20/10/5/2":  lambda sc, v, a: 20.0 if a >= 1.5 else (10.0 if a >= 1.0 else (5.0 if a >= 0.3 else 2.0)),
    }
    ...
    for period, start, end in [
        ...
        print(f"\n{'='*80}")
        print(f"  {period}")
        print(f"  규칙: |sc|>=1.5 / |sc|>=1.0 / |sc|>=0.3 / else")
        print(f"{'='*80}")
        ...
        hdr = f"  {'전략':<15s} | {'일':>3s} | {'Net':>10s} | {'SR':>5s} | {'HR':>5s} | {'MDD':>8s} | {'avg_lev':>7s}"
        sep = f"  {'-'*15}-+-{'-'*3}-+-{'-'*10}-+-{'-'*5}-+-{'-'*5}-+-{'-'*8}-+-{'-'*7}"
        print(hdr)
        print(sep)
        for name in strategies:
            r = results[name]
            print(f"  {name:<15s} | {r['n_days']:>3d} | {r['total_net']*100:+9.1f}% | {r['sharpe']:+4.2f} | {r['hit_rate']*100:4.1f}% | {r['max_dd']*100:+7.2f}% | {r['avg_lev']:6.2f}x")

        # IS/OOS Sharpe 비율 계산용
        print()
