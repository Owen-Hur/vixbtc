...
추가 구간에서 r이 -0.180이고 p가 7.3×10⁻⁹(< 10⁻⁸)이어도, 방향 적중률은 49.65%다. **상관계수가 매우 유의해도 방향이 맞지 않으면 거래 엣지가 아니다.** 본 분석에서 가장 중요한 통계적 통찰이다.
...
4. **추가 구간(2020~2023)**: 상관은 매우 유의(p = 7.3×10⁻⁹)하나 적중률은 여전히 50% 부근. 변동성 동조이지 방향 예측 아님.
